...
fun MisComprasScreen(
    viewModel: MisComprasViewModel = viewModel(factory = AppViewModelProvider.Factory),
    onBackPress: () -> Unit
) {
 ...
 */
@Composable
private fun PurchaseItem(purchase: VentaEntity) {
        ...
        Column(Modifier.padding(16.dp)) {
            ...
            Row(
                ...
                Column {
                    Text(
                        // Formatea la fecha
                        text = "Compra: ${purchase.fecha}", // Usamos String directo si es ISO, o parseamos si es necesario. Por ahora directo.
                ...
                Column(modifier = Modifier.padding(top = 16.dp)) {
                    ...
                    purchase.detalles.forEach { item ->
                        Row(
                            ...
                            Text(formatPrice(item.precio * item.cantidad))
                        }
                    }
                }
            }
